...
# Function to generate and save an image given a target label
def generate_image(target_label, generator, latent_dim=100, num_classes=10):
    ...
    if not os.path.exists('images'):
        os.makedirs('images')
    save_image(gen_img.data, f"generated_{target_label}.png", normalize=True)
...
generate_image(target_label, generator)
